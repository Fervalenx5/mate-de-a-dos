...
$sourcePath = "C:\Users\Usuario\.gemini\antigravity-ide\brain\62f4b2a9-9b9e-4f14-9761-618688d0387c\media__1785455877221.png"
...
for ($x = 0; $x -lt $img.Width; $x++) {
    for ($y = 0; $y -lt $img.Height; $y++) {
        ...
        # Eliminar el fondo beige tenue (RGB cercano a 247, 243, 238)
        if (($r -gt 225 -and $g -gt 215 -and $b -gt 205) -and ([Math]::Abs($r - $g) -lt 20)) {
...
$img.Dispose()
$target.Dispose()
Write-Host "Nuevo logo con fondo transparente guardado con exito."
